...
public class CaseSmallWithNoOperators extends TestCase {

	public CaseSmallWithNoOperators() {
		this.caseName = "Small with no operators";
	}
	
	public void run() {
		
		String[] testArgs = new String[1];
		testArgs[0] = "testFiles/1.in.txt";
		...
		boolean outputMatch = super.stdoutMatch("testFiles/1.out.txt");
